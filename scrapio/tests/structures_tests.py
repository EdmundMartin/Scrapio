...
class TestURLFiltering(unittest.TestCase):
    ...
    def test_can_crawl_crawlable_url(self):
        test_filter = URLFilter([urlparse('http://www.example.com').netloc], None, False)
        can_crawl = test_filter.can_crawl('www.example.com', 'http://example.com/something/something-else')
    ...
    def test_can_crawl_crawlable_url_additional_rules(self):
        test_filter = URLFilter([urlparse('http://www.example1.com').netloc, urlparse('http://www.example2.com').netloc],
                                ['/adult-content', 'example2.com/product'], False)
        can_crawl = test_filter.can_crawl('www.example1.com', 'http://www.example1.com/something-good')
        self.assertTrue(can_crawl)
        can_crawl = test_filter.can_crawl('www.example2.com', 'http://www.example2.com/something-good')
        self.assertTrue(can_crawl)

    def test_can_crawl_do_not_crawl_additional_rules(self):
        test_filter = URLFilter(
            [urlparse('http://www.example1.com').netloc, urlparse('http://www.example2.com').netloc],
            ['/adult-content', 'example2.com/product'], False)
        can_crawl = test_filter.can_crawl('www.example1.com', 'http://www.example1.com/adult-content')
        self.assertFalse(can_crawl)
        can_crawl = test_filter.can_crawl('www.example2.com', 'http://www.example2.com/product-101')
        self.assertFalse(can_crawl)